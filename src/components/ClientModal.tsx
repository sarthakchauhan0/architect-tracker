...
export const ClientModal: React.FC<ClientModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs p-4 overflow-y-auto animate-in fade-in duration-150">
      <div className="w-full max-w-2xl bg-white border border-[#e5e3dc] rounded-2xl shadow-2xl overflow-hidden my-8">
        <div className="flex items-center justify-between px-6 py-4 border-b border-stone-200 bg-stone-50/80">
          <div className="flex items-center gap-2.5">
            <div className="p-2 rounded-lg bg-[#f5efe9] text-[#a67d5d]">
              <Building className="w-5 h-5" />
            </div>
            <div>
              <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-[#a67d5d] block">
                Commission Setup
              </span>
              <h2 className="text-base font-bold text-[#141414]">
                {clientToEdit ? 'Edit Client & Project Commission' : 'Register New Architectural Commission'}
              </h2>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-stone-50 border border-stone-200 rounded-lg text-stone-900 text-sm placeholder-stone-400 focus:outline-none focus:border-[#a67d5d] focus:bg-white transition-colors"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2.5 bg-stone-50 border border-stone-200 rounded-lg text-stone-900 text-sm focus:outline-none focus:border-[#a67d5d] focus:bg-white transition-colors font-medium"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-xl bg-[#fcfbf9] border border-stone-200">
            <div>
              <label className="block text-[11px] font-bold text-stone-700 uppercase tracking-wider mb-1.5 flex items-center gap-1.5">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-white border border-stone-200 rounded-lg text-stone-900 text-sm focus:outline-none focus:border-[#a67d5d] transition-colors font-medium"
              />
            ...
            <div>
              <label className="block text-[11px] font-bold text-stone-700 uppercase tracking-wider mb-1.5 flex items-center gap-1.5">
                <IndianRupee className="w-3.5 h-3.5 text-[#a67d5d]" />
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2 bg-stone-50 border border-stone-200 rounded-lg text-stone-900 text-sm placeholder-stone-400 focus:outline-none focus:border-[#a67d5d] focus:bg-white transition-colors"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-stone-200">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-xs font-bold uppercase tracking-wider text-stone-700 bg-stone-100 hover:bg-stone-200 rounded-lg transition-colors"
            >
              Cancel
            </button>
            <button
            ...
            >
              ...
              {isSubmitting ? 'Saving...' : clientToEdit ? 'Save Changes' : 'Create Commission'}
            </button>
          </div>
        </form>
      </div>
